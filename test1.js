...
let users = [ ]
 //let addUser = function (  pName, pCountry) 👉154行目と同義
...
try
{
  um.deleteUser( -1);  //👉少数点がある数値かつマイナスの数値であればなんでもいい。
}
catch ( e)
{
  console.log( e); //👉 e = "ユーザー番号にマイナスが指定されました"
}
// (e)228行目 と let e = new Error は同義　👉「throw」211行目と「catch」228行目によって,Error( "ユーザー番号にマイナスが指定されました")の（新）インスタンスは(e)に代入される。
/* Error( "ユーザー番号にマイナスが指定されました")*/
